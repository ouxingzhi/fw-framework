...
/**
 * 中文转换拼音类
 * 转自:http://www.cnblogs.com/hxtgirq710/archive/2013/02/18/2915353.html
 */
...
'zui'=>-10260,'zun'=>-10256,'zuo'=>-10254
     ...
     *    @return string 
     +---------------------------------------------------------------------------------
     */
    public static function getFull($chinese, $delimiter = '', $length = 0,$charset='utf-8') {
     ...
     *    @return string
     +--------------------------------------------------------------------------------
     */
    public static function getFirst($chinese,$charset='utf-8'){
      if($charset != 'gb2312') $chinese = self::_U2_Utf8_Gb($chinese);
       $result = '' ;
